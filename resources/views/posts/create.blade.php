        ...
        <form action="{{ route('posts.store') }}" method="POST" novalidate>
            ...
            <div class="mb-5">
                ...
                <input class="border p-3 w-full rounded-lg @error('titulo') border-red-500 @enderror" type="text"
                    name="titulo" id="titulo" placeholder="Titulo de la publicacion" value="{{ old('titulo') }}" />
            ...
            <div class="mb-5">
                ...
                <textarea name="descripcion" id="descripcion" placeholder="Descripción de una publicación" class="border p-3 w-full rounded-lg
                @error('descripcion')
                     border-red-500
